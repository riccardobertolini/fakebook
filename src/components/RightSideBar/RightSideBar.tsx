...
All the design has been manually written using styled-components. A natural next step for this project would be wrapping the React app in a Next.js framework, to cache the API calls, setting login logic and server-side render.
				</AccordionText>
			</SideSection>
		</RightSideMenu>
	) : null;
